...
public class DirectionMap {
	...
	public static DirectionMap getDirectionMap(ItemFrame frame) {
		switch (frame.getRotation()) {
			case FLIPPED -> {
				return new DirectionMap("NORTH", "EAST", "SOUTH", "WEST");
			}
			case COUNTER_CLOCKWISE -> {
				return new DirectionMap("EAST", "SOUTH", "WEST", "NORTH");
			}
			case NONE -> {
				return new DirectionMap("SOUTH", "WEST", "NORTH", "EAST");
			}
			case CLOCKWISE -> {
				return new DirectionMap("WEST", "NORTH", "EAST", "SOUTH");
			}
			default -> {
				return null;
			}
